import { BogusProvablePure } from './BogusProvablePure';
import {
  Mina,
  PrivateKey,
  PublicKey,
...
describe('Lots of Actions', () => {
  let deployerAccount: PublicKey,
    ...
    zkApp: BogusProvablePure;

  beforeAll(async () => {
    if (proofsEnabled) await BogusProvablePure.compile();
  });
  ...
  beforeEach(() => {
    ...
    zkApp = new BogusProvablePure(zkAppAddress);
  });
